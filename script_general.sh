...
if [[ $PROJECT_SCHEME != ROADAttributesCodeGenerator ]]; then xctool $PATCH_FOR_PROJECT_OR_WORKSPACE -scheme $PROJECT_SCHEME test -sdk iphonesimulator7.0 || EXIT_STATUS=$?; fi
